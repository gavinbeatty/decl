...
#
#  decl_FOUND              - If false, no decl headers were found.
#  decl_VERSION_MAJOR      - The major version decl found.
#  decl_VERSION_MINOR      - The minor version decl found.
#  decl_VERSION_PATCH      - The patch version decl found.
#  decl_VERSION_STRING     - The version string, i.e., major.minor.patch
#                            format.
#
#  decl_INCLUDE_DIRS       - List of include directories to add when compiling
#                            code using decl.
#
#  decl_LIBRARIES          - List of decl's libraries.
#
#  decl_SHARED_LIBRARIES   - List of decl's libraries as shared libraries.
#
#  decl_STATIC_LIBRARIES   - List of decl's libraries as static libraries.
#
# You can set the following variables to aid in finding decl:
#
#  DECL_EXPORT_DIR         - Hints for the path leading to the CMake export file.
#                            e.g., /opt/decl-1.0.0/lib/decl, C:\decl-1.0.0\lib\decl
#
#  EXPORT_ROOT_DIR           - After DECL_EXPORT_DIR, we try:
#                               ${EXPORT_ROOT_DIR}/lib/decl
#
#  DECL_EXPORT_FILENAME    - The base filename of the CMake export file.
#                            e.g., Exportdecl-1.cmake, Exportdecl-1.0.0.cmake
#
# You may have multiple versions of decl installed. To select whichever one you
# are using, below is the recommended strategy:
#
# If you have installed decl to its own prefix, such as /opt/decl-1.0:
# set DECL_EXPORT_DIR=/opt/decl-1.0/lib/decl. It will pick up the CMake export
# file at /opt/decl-1.0/lib/decl/Exportdecl.cmake.
#
# If you have installed decl to a shared prefix, such as /usr/local:
# set DECL_EXPORT_DIR=/usr/local/lib/decl
# set DECL_EXPORT_FILENAME=Exportdecl-1.0.0.cmake
# or whatever version you require.
#
# CMake 2.6 module syntax is supported.
# i.e.,
#
#  find_package(decl [<major>[.<minor>[.<patch>]]] [EXACT]
#               [QUIET] [REQUIRED])
#
#
...
m_req_dep("${_p}" plat NOTEXACT "1.5" "${_p}_plat_found")
